...
import { uploadToken } from '../redux/actions/footerActions'
    ...
    return (
        <div className='form-container'>
            <form onSubmit={submitHandler} className='form-box'>
                <h4 style={{textAlign:'center'}}>Upload Token</h4>
                <label>
                    Token Name:
                ...
                <button className='sub-button' type='submit'>Upload Token</button>
            </form>
        </div>
    )

...
import { uploadSocialMedia } from '../redux/actions/footerActions'
...
export default function UploadMediaScreen() {
    ...
    const submitHandler = (e) => {
        ...
        dispatch(uploadSocialMedia(formData))
    ...
    return (
        <div className='form-container'>
            <form onSubmit={submitHandler} className='form-box'>
                <h4 style={{textAlign:'center'}}>Upload Social Media</h4>
                <label>
                    Social Media Name:
                ...
                <button className='sub-button' type='submit'>Upload Social Media</button>
            </form>
        </div>
    )
}
